...
import SmartAICard from '../components/SmartAICard';
  ...
  return (
    <div className="animate-fade">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '2rem' }}>
        ...
        <aside>
          <SmartAICard tasks={tasks} />
          
          <div className="glass" style={{ marginTop: '1.5rem', padding: '1.5rem', borderRadius: '20px' }}>
            <h3 style={{ fontSize: '1rem', fontWeight: '700', marginBottom: '1rem' }}>Categories</h3>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {['Work', 'Personal', 'Health', 'Finance'].map(cat => (
                <span key={cat} style={{ padding: '6px 12px', background: 'rgba(255,255,255,0.05)', borderRadius: '20px', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                  {cat}
                </span>
              ))}
            </div>
